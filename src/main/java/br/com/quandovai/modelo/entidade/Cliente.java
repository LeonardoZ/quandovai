...
@NamedQueries({
	@NamedQuery(name="Cliente.buscaPorNomeParcial",
		    query="select c from Cliente c where c.nomeCompleto like :nome"),
	@NamedQuery(name="Cliente.countPorNomeParcial",
		    query="select count(c) from Cliente c where c.nomeCompleto like :nome")}
)
