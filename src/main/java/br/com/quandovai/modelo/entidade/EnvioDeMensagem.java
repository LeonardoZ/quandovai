...
@NamedQueries({
    @NamedQuery(name="envioMensagem.ultimasDe5Minutos", 
	    	query="select e from EnvioDeMensagem e "
...
public class EnvioDeMensagem extends Entidade {
    ...
    public static EnvioDeMensagem criarEnvio(Cliente cliente, Mensagem mensagem) {
